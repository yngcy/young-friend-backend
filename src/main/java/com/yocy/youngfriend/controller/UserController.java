...
import com.yocy.youngfriend.model.domain.request.UserLoginRequest;
import com.yocy.youngfriend.model.domain.request.UserRegisterRequest;
...
public class UserController {
    ...
    public BaseResponse<Page<User>> recommendUsers(long pageSize, long pageNum, HttpServletRequest request) {
        ...
        String redisKey = String.format("young-friend:user:recommend:%s", loginUser.getId());
        ValueOperations<String, Object> valueOperation = redisTemplate.opsForValue();
        // 如果有缓存，直接读缓存
        Page<User> userPage = (Page<User>) valueOperation.get(redisKey);
        if (userPage != null) {
